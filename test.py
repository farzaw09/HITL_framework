...
# FILE PATHS
# =========================
BASE_DATASET = "dataset_test.json"
...
# =========================
# LOAD DATA (per annotator)
# =========================
if annotator == "admin":
    # admin view can inspect A/B separately (read-only style)
    st.info("Admin mode: viewing annotator progress (not editing base dataset)")

    # default view A first
    view_file = st.selectbox("View progress file", ["progress_A.json", "progress_B.json"])
