...
# removes old "label" field completely
# =========================
...
if st.button("Save Sample"):
    ...
    with open("corrected_test.json", "w", encoding="utf-8") as f:
